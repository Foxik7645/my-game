...
const ROCK_ICONS = [
  new L.Icon({iconUrl:'../images/Rock1.png', iconSize:[48,48], iconAnchor:[24,36]}),
  new L.Icon({iconUrl:'../images/Rock2.png', iconSize:[48,48], iconAnchor:[24,36]}),
  new L.Icon({iconUrl:'../images/Rock3.png', iconSize:[48,48], iconAnchor:[24,36]}),
];
const rocks = new Map();
...
function createWorkerFromDoc(workerId, homeId, type, expiresAtMs, localOnly=false){
  ...
  setMarkerHidden(m, !isSpriteZoomVisible(map.getZoom()));
  m.worker = { id: workerId, type, state:'wander',
