diff --git a//dev/null b/js/state.js
index 0000000000000000000000000000000000000000..4c8144c861ae95130256472887c32300c065a2ef 100644
--- a//dev/null
+++ b/js/state.js
@@ -0,0 +1,72 @@
...
+}
+
+export function setLevelXp(lvl, newXp){
+  level = lvl;
+  xp = newXp;
+}
