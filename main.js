...
index 0000000000000000000000000000000000000000..f61161a0e36c284ddd806b9d6a48a4fc8dec66f4 100644
--- a//dev/null
+++ b/main.js
@@ -0,0 +1,1333 @@
+/* ---------- Firebase ---------- */
...
+
+function pruneForeignResources(collection){
+  collection.forEach((t,id)=>{
+    if(t.owner!==uid){
+      try{ map.removeLayer(t.marker); }catch{}
